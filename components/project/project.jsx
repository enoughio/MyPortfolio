...
export default function ({ data }) {
  if (!data) {
    // To debug or track cases where data is not passed, you can log a warning:
  ...
  return (
    <div className=" border-2 border-zinc-400 rounded-xl py-1 px-4 min-w-fit">
      ...
      <div className="flex gap-2">
        {isOnGithub && (
          <Button asChild className=" my-2 mx-1 md:mt-5">
            <div>
              <ImGithub />
